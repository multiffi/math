...
public class JDKMathProvider extends MathProvider {
    ...
    private static final class MultiplyHigh {
        ...
        private static final MethodHandle multiplyHighMethodHandle;
        private static final LongBinaryOperator multiplyHighFunction;
        static {
            MethodHandle methodHandle;
            try {
                methodHandle = MethodHandles.publicLookup().findStatic(
                        Math.class, "multiplyHigh",
                        MethodType.methodType(long.class, long.class, long.class)
                );
            } catch (NoSuchMethodException | IllegalAccessException e) {
                methodHandle = null;
            }
            multiplyHighMethodHandle = methodHandle;
            LongBinaryOperator function;
            if (multiplyHighMethodHandle == null) function = (multiplicand, multiplier) -> {
            ...
            else function = (multiplicand, multiplier) -> {
                try {
                    return (long) multiplyHighMethodHandle.invokeExact(multiplicand, multiplier);
                } catch (Throwable e) {
            ...
            multiplyHighFunction = function;
        }
        public static long compute(long multiplicand, long multiplier) {
            return multiplyHighFunction.applyAsLong(multiplicand, multiplier);
        }
    }
    ...
    private static final class UnsignedMultiplyHigh {
        ...
        private static final MethodHandle unsignedMultiplyHighMethodHandle;
        private static final LongBinaryOperator unsignedMultiplyHighFunction;
        static {
            MethodHandle methodHandle;
            try {
                methodHandle = MethodHandles.publicLookup().findStatic(
                        Math.class, "unsignedMultiplyHigh",
                        MethodType.methodType(long.class, long.class, long.class)
                );
            } catch (NoSuchMethodException | IllegalAccessException e) {
                methodHandle = null;
            }
            unsignedMultiplyHighMethodHandle = methodHandle;
            LongBinaryOperator function;
            if (unsignedMultiplyHighMethodHandle == null) function = (multiplicand, multiplier) -> {
                ...
                try {
                    return (long) unsignedMultiplyHighMethodHandle.invokeExact(multiplicand, multiplier);
                } catch (Throwable e) {
                    if (e instanceof Error) throw (Error) e;
                    else if (e instanceof RuntimeException) throw (RuntimeException) e;
                    else throw new IllegalStateException(e);
            ...
            unsignedMultiplyHighFunction = function;
        }
        public static long compute(long multiplicand, long multiplier) {
            return unsignedMultiplyHighFunction.applyAsLong(multiplicand, multiplier);
        }
    }
    ...
    @FunctionalInterface
    private interface FloatTernaryOperator {
    ...
    private static final class FusedMultiplyAdd {
        private FusedMultiplyAdd() {
            throw new UnsupportedOperationException();
        }
        private static final MethodHandle fmaDoubleHandle;
        private static final DoubleTernaryOperator fmaDoubleFunction;
        static {
            MethodHandle methodHandle;
            try {
                methodHandle = MethodHandles.publicLookup().findStatic(
            ...
            fmaDoubleHandle = methodHandle;
            DoubleTernaryOperator function;
            if (fmaDoubleHandle == null) function = (multiplicand, multiplier, addend) -> {
                /*
            ...
            else function = (multiplicand, multiplier, addend) -> {
                try {
                    return (double) fmaDoubleHandle.invokeExact(multiplicand, multiplier, addend);
                } catch (Throwable e) {
                    if (e instanceof Error) throw (Error) e;
                    else if (e instanceof RuntimeException) throw (RuntimeException) e;
                    else throw new IllegalStateException(e);
            ...
            fmaDoubleFunction = function;
        }
        private static final MethodHandle fmaFloatHandle;
        private static final FloatTernaryOperator fmaFloatFunction;
        static {
            MethodHandle methodHandle;
            try {
                methodHandle = MethodHandles.publicLookup().findStatic(
            ...
            fmaFloatHandle = methodHandle;
            FloatTernaryOperator function;
            if (fmaFloatHandle == null) function = (multiplicand, multiplier, addend) -> {
                if (Float.isFinite(multiplicand) && Float.isFinite(multiplier) && Float.isFinite(addend)) {
                    ...
                    return (float) fmaDoubleFunction.applyAsDouble((double) multiplicand, (double) multiplier, (double) addend);
                }
            };
            else function = (multiplicand, multiplier, addend) -> {
                try {
                    return (float) fmaFloatHandle.invokeExact(multiplicand, multiplier, addend);
                } catch (Throwable e) {
                    if (e instanceof Error) throw (Error) e;
                    else if (e instanceof RuntimeException) throw (RuntimeException) e;
                    else throw new IllegalStateException(e);
            ...
            fmaFloatFunction = function;
        }
        public static float compute(float multiplicand, float multiplier, float addend) {
            return fmaFloatFunction.applyAsFloat(multiplicand, multiplier, addend);
        }
        public static double compute(double multiplicand, double multiplier, double addend) {
            return fmaDoubleFunction.applyAsDouble(multiplicand, multiplier, addend);
        }
    }
    ...
    private static final class Compress {
        ...
        private static final MethodHandle compressIntMethodHandle;
        private static final IntBinaryOperator compressIntFunction;
        static {
            MethodHandle methodHandle;
            try {
                methodHandle = MethodHandles.publicLookup().findStatic(
                        Integer.class, "compress",
                        MethodType.methodType(int.class, int.class, int.class)
                );
            } catch (NoSuchMethodException | IllegalAccessException e) {
                methodHandle = null;
            }
            compressIntMethodHandle = methodHandle;
            IntBinaryOperator function;
            if (compressIntMethodHandle == null) function = (value, mask) -> {
                ...
                try {
                    return (int) compressIntMethodHandle.invokeExact(value, mask);
                } catch (Throwable e) {
                    if (e instanceof Error) throw (Error) e;
                    else if (e instanceof RuntimeException) throw (RuntimeException) e;
                    else throw new IllegalStateException(e);
            ...
            compressIntFunction = function;
        }
        private static final MethodHandle compressLongMethodHandle;
        private static final LongBinaryOperator compressLongFunction;
        static {
            MethodHandle methodHandle;
            try {
                methodHandle = MethodHandles.publicLookup().findStatic(
            ...
            compressLongMethodHandle = methodHandle;
            LongBinaryOperator function;
            if (compressLongMethodHandle == null) function = (value, mask) -> {
                // See Hacker's Delight (2nd ed) section 7.4 Compress, or Generalized Extract
                ...
                try {
                    return (long) compressLongMethodHandle.invokeExact(value, mask);
                } catch (Throwable e) {
                    if (e instanceof Error) throw (Error) e;
                    else if (e instanceof RuntimeException) throw (RuntimeException) e;
                    else throw new IllegalStateException(e);
            ...
            compressLongFunction = function;
        }
        public static int compute(int value, int mask) {
            return compressIntFunction.applyAsInt(value, mask);
        }
        public static long compute(long value, long mask) {
            return compressLongFunction.applyAsLong(value, mask);
        }
    }
    ...
    private static final class Expand {
        ...
        private static final MethodHandle expandIntMethodHandle;
        private static final IntBinaryOperator expandIntFunction;
        static {
            MethodHandle methodHandle;
            try {
                methodHandle = MethodHandles.publicLookup().findStatic(
                        Integer.class, "expand",
                        MethodType.methodType(int.class, int.class, int.class)
                );
            } catch (NoSuchMethodException | IllegalAccessException e) {
                methodHandle = null;
            }
            expandIntMethodHandle = methodHandle;
            IntBinaryOperator function;
            if (expandIntMethodHandle == null) function = (value, mask) -> {
                // Save original mask
                ...
                try {
                    return (int) expandIntMethodHandle.invokeExact(value, mask);
                } catch (Throwable e) {
                    if (e instanceof Error) throw (Error) e;
                    else if (e instanceof RuntimeException) throw (RuntimeException) e;
                    else throw new IllegalStateException(e);
            ...
            expandIntFunction = function;
        }
        private static final MethodHandle expandLongMethodHandle;
        private static final LongBinaryOperator expandLongFunction;
        static {
            MethodHandle methodHandle;
            try {
                methodHandle = MethodHandles.publicLookup().findStatic(
            ...
            expandLongMethodHandle = methodHandle;
            LongBinaryOperator function;
            if (expandLongMethodHandle == null) function = (value, mask) -> {
                // Save original mask
                ...
                try {
                    return (int) expandLongMethodHandle.invokeExact(value, mask);
                } catch (Throwable e) {
                    if (e instanceof Error) throw (Error) e;
                    else if (e instanceof RuntimeException) throw (RuntimeException) e;
                    else throw new IllegalStateException(e);
            ...
            expandLongFunction = function;
        }
        public static int compute(int value, int mask) {
            return expandIntFunction.applyAsInt(value, mask);
        }
        public static long compute(long value, long mask) {
            return expandLongFunction.applyAsLong(value, mask);
        }
    }
